# -*- coding: utf-8 -*-
"""
Created on Thu Oct  3 10:03:42 2019
...
xstep = 100 #Number of steps in the m loop.
ystep = N2  #Number of trials.
x1_2d = reshape(Narr, (xstep, ystep))
y1_2d = reshape(muarr, (xstep, ystep))
z1_2d = reshape(chi2, (xstep, ystep))
plt.plot([0.0, 100], [0.5, 0.5]) #Expectation value of a fair coin: m = 0.5
plt.xlim(0, 100)
